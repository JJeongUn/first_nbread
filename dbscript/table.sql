...
CREATE TABLE COMMENTS (
	...
	ME_NUM NUMBER NOT NULL, /* 댓글 쓴 사람 */
...
COMMENT ON COLUMN COMMENTS.ME_NUM IS '댓글 쓴 사람';
...
COMMENT ON COLUMN QA.QA_NUM IS 'QNA 번호';
...
COMMENT ON COLUMN QACOMMENTS.QA_COM_NUM IS 'QNA 댓글 번호';
...
COMMENT ON COLUMN MEMBER.ME_MOD_DATE IS '회원 정보 수정';

COMMENT ON COLUMN MEMBER.CAT_NUM IS '카테고리 테이블 번호';
...
CREATE TABLE FOLLOWING (
	ME_NUM NUMBER NOT NULL, /* 회원 넘버 */
	ME_NUM2 NUMBER NOT NULL, /* 회원 넘버2 */
...
COMMENT ON COLUMN NOTE.SEND_NUM IS '보낸 사람';

COMMENT ON COLUMN NOTE.RECV_NUM IS '받는 사람';
...
COMMENT ON COLUMN TOTALPARTY.ME_NUM IS '회원 넘버';

COMMENT ON COLUMN TOTALPARTY.PAY_OK IS '결제여부';
...
COMMENT ON COLUMN NOTICE.NO_NUM IS '공지사항 번호';
...
COMMENT ON COLUMN NOTICECOMMENTS.NO_COM_NUM IS '공지사항 댓글 번호';
...
COMMENT ON COLUMN NOTICEPHOTO.NO_PH_NUM IS '사진 테이블 번호';
...
COMMENT ON COLUMN MAIN_CATEGORY.CAT_NUM IS '카테고리 테이블 번호';
...
COMMENT ON COLUMN SUB_CATEGORY.CAT_SUB_NUM IS '소분류 카테고리 번호';
...
CREATE TABLE CHAT (
	...
	PA_NUM NUMBER, /* 파티 번호 */
	ME_NAME VARCHAR2(100), /* 회원 이름 or 닉네임 */
	CHAT_CON VARCHAR2(2000) NOT NULL, /* 채팅 내용 */
	CHAT_DATE DATE DEFAULT SYSDATE /* 채팅 보낸시간 */
);

COMMENT ON TABLE CHAT IS '채팅';

COMMENT ON COLUMN CHAT.CHAT_NUM IS '채팅 번호';

COMMENT ON COLUMN CHAT.PA_NUM IS '파티 번호';

COMMENT ON COLUMN CHAT.ME_NAME IS '회원 이름 or 닉네임';

COMMENT ON COLUMN CHAT.CHAT_CON IS '채팅 내용';
...
CREATE TABLE advertisement (
	AD_NUM NUMBER NOT NULL, /* 광고 테이블 번호 */
	AD_TITLE VARCHAR2(200), /* 광고 이름 */
	AD_URL VARCHAR2(500), /* 광고주 홈페이지 */
	AD_PAY NUMBER, /* 광고료 */
	AD_SIGN_OFF_ON CHAR DEFAULT 'N', /* 광고 게시 여부 */
	AD_ENROLL DATE DEFAULT SYSDATE, /* 글 작성 날짜 */
	AD_STA_DATE DATE, /* 광고 시작일 */
	AD_END_DATE DATE, /* 광고 종료일 */
	AD_LEV NUMBER, /* 게시글 깊이 */
	ME_NUM NUMBER, /* 광고 게시자 */
	AD_PH_NUM NUMBER /* 광고 사용 이미지 테이블 번호 */
);

COMMENT ON TABLE advertisement IS '새 테이블';

COMMENT ON COLUMN advertisement.AD_NUM IS '광고 테이블 번호';

COMMENT ON COLUMN advertisement.AD_TITLE IS '광고 이름';

COMMENT ON COLUMN advertisement.AD_URL IS '광고주 홈페이지';

COMMENT ON COLUMN advertisement.AD_PAY IS '광고료';

COMMENT ON COLUMN advertisement.AD_SIGN_OFF_ON IS '광고 게시 여부';

COMMENT ON COLUMN advertisement.AD_ENROLL IS '글 작성 날짜';

COMMENT ON COLUMN advertisement.AD_STA_DATE IS '광고 시작일';

COMMENT ON COLUMN advertisement.AD_END_DATE IS '광고 종료일';

COMMENT ON COLUMN advertisement.AD_LEV IS '게시글 깊이';

COMMENT ON COLUMN advertisement.ME_NUM IS '광고 게시자';

COMMENT ON COLUMN advertisement.AD_PH_NUM IS '광고 사용 이미지 테이블 번호';
...
CREATE TABLE ADPHOTO (
	AD_PH_NUM NUMBER NOT NULL, /* 광고 사용 이미지 테이블 번호 */
	AD_PHOTO1 VARCHAR2(200), /* 광고 사진1 */
	AD_PHOTO2 VARCHAR2(200), /* 광고 사진2 */
	AD_PHOTO3 VARCHAR2(200), /* 광고 사진3 */
	AD_PHOTO4 VARCHAR2(200), /* 광고 사진4 */
	AD_PHOTO5 VARCHAR2(200) /* 광고 사진5 */
);

COMMENT ON TABLE ADPHOTO IS '새 테이블2';

COMMENT ON COLUMN ADPHOTO.AD_PH_NUM IS '광고 사용 이미지 테이블 번호';

COMMENT ON COLUMN ADPHOTO.AD_PHOTO1 IS '광고 사진1';

COMMENT ON COLUMN ADPHOTO.AD_PHOTO2 IS '광고 사진2';

COMMENT ON COLUMN ADPHOTO.AD_PHOTO3 IS '광고 사진3';

COMMENT ON COLUMN ADPHOTO.AD_PHOTO4 IS '광고 사진4';

COMMENT ON COLUMN ADPHOTO.AD_PHOTO5 IS '광고 사진5';

CREATE UNIQUE INDEX PK_ADPHOTO
	ON ADPHOTO (
		AD_PH_NUM ASC
	);
...
CREATE TABLE business (
	BU_NUM NUMBER NOT NULL, /* 비지니스 테이블 번호 */
	ME_NUM NUMBER NOT NULL, /* 작성자 */
	BU_TITLE VARCHAR2(200) NOT NULL, /* 제목 */
	BU_PWD VARCHAR2(200), /* 비밀번호 */
	BU_CON VARCHAR2(2000) NOT NULL, /* 내용 */
	BU_ENROLL DATE DEFAULT SYSDATE, /* 게시일 */
	BU_MOD_DATE DATE, /* 수정날짜 */
	BU_DEL_DATE DATE, /* 삭제 날짜 */
	BU_VIEWS NUMBER DEFAULT 0, /* 조회수 */
	BU_LEV NUMBER DEFAULT 1, /* 댓글 깊이 */
	BU_PH_NUM NUMBER /* 비지니스 사진 테이블 번호 */
);

COMMENT ON TABLE business IS '새 테이블3';

COMMENT ON COLUMN business.BU_NUM IS '비지니스 테이블 번호';

COMMENT ON COLUMN business.ME_NUM IS '작성자';

COMMENT ON COLUMN business.BU_TITLE IS '제목';

COMMENT ON COLUMN business.BU_PWD IS '비밀번호';

COMMENT ON COLUMN business.BU_CON IS '내용';

COMMENT ON COLUMN business.BU_ENROLL IS '게시일';

COMMENT ON COLUMN business.BU_MOD_DATE IS '수정날짜';

COMMENT ON COLUMN business.BU_DEL_DATE IS '삭제 날짜';

COMMENT ON COLUMN business.BU_VIEWS IS '조회수';

COMMENT ON COLUMN business.BU_LEV IS '댓글 깊이';

COMMENT ON COLUMN business.BU_PH_NUM IS '비지니스 사진 테이블 번호';
...
/* 새 테이블4 */
CREATE TABLE BUPHOTO (
	BU_PH_NUM NUMBER NOT NULL, /* 비지니스 사진 테이블 번호 */
	BU_PH_PHOTO1 VARCHAR2(100), /* 사진1 */
	BU_PH_PHOTO2 VARCHAR2(100), /* 사진2 */
	BU_PH_PHOTO3 VARCHAR2(100), /* 사진3 */
	BU_PH_PHOTO4 VARCHAR2(100), /* 사진4 */
	BU_PH_PHOTO5 VARCHAR2(100) /* 사진5 */
);

COMMENT ON TABLE BUPHOTO IS '새 테이블4';

COMMENT ON COLUMN BUPHOTO.BU_PH_NUM IS '비지니스 사진 테이블 번호';

COMMENT ON COLUMN BUPHOTO.BU_PH_PHOTO1 IS '사진1';

COMMENT ON COLUMN BUPHOTO.BU_PH_PHOTO2 IS '사진2';

COMMENT ON COLUMN BUPHOTO.BU_PH_PHOTO3 IS '사진3';

COMMENT ON COLUMN BUPHOTO.BU_PH_PHOTO4 IS '사진4';

COMMENT ON COLUMN BUPHOTO.BU_PH_PHOTO5 IS '사진5';

CREATE UNIQUE INDEX PK_BUPHOTO
	ON BUPHOTO (
		BU_PH_NUM ASC
	);
...
/* 새 테이블5 */
CREATE TABLE report (
	RP_NUM NUMBER NOT NULL, /* 신고번호 */
	RP_TYPE VARCHAR2(200) NOT NULL, /* 신고종류 */
	RP_DATE DATE NOT NULL, /* 신고 날짜 */
	RP_CON VARCHAR2(500), /* 신고내용 */
	RP_PROC CHAR, /* 처리유무 */
	RP_PROC_DATE DATE, /* 처리날짜 */
	ME_NUM NUMBER, /* 회원 넘버 */
	PA_NUM NUMBER, /* 파티 번호 */
	COM_NUM NUMBER, /* 댓글 번호 */
	AD_NUM NUMBER /* 광고 테이블 번호 */
);

COMMENT ON TABLE report IS '새 테이블5';

COMMENT ON COLUMN report.RP_NUM IS '신고번호';

COMMENT ON COLUMN report.RP_TYPE IS '신고종류';

COMMENT ON COLUMN report.RP_DATE IS '신고 날짜';

COMMENT ON COLUMN report.RP_CON IS '신고내용';

COMMENT ON COLUMN report.RP_PROC IS '처리유무';

COMMENT ON COLUMN report.RP_PROC_DATE IS '처리날짜';

COMMENT ON COLUMN report.ME_NUM IS '회원 넘버';

COMMENT ON COLUMN report.PA_NUM IS '파티 번호';

COMMENT ON COLUMN report.COM_NUM IS '댓글 번호';

COMMENT ON COLUMN report.AD_NUM IS '광고 테이블 번호';
...
ALTER TABLE TOTALPARTY
	ADD
		CONSTRAINT FK_MEMBER_TO_TOTALPARTY
		FOREIGN KEY (
			ME_NUM
		)
		REFERENCES MEMBER (
...
ALTER TABLE advertisement
	ADD
		CONSTRAINT FK_ADPHOTO_TO_advertisement
		FOREIGN KEY (
			AD_PH_NUM
		)
		REFERENCES ADPHOTO (
...
ALTER TABLE business
	ADD
		CONSTRAINT FK_BUPHOTO_TO_business
		FOREIGN KEY (
			BU_PH_NUM
		)
		REFERENCES BUPHOTO (
...
ALTER TABLE report
	ADD
		CONSTRAINT FK_advertisement_TO_report
		FOREIGN KEY (
			AD_NUM
		)
...
insert into member
values (0,'temp','temp','temp',0,'N','N','test@test.test','00000000000',NULL,'M',NULL,SYSDATE,NULL,0,NULL,'N','N',0,SYSDATE,NULL);

insert into photo
values (0,null,null,null,null,null);
commit;

insert into noticephoto
values (0,null,null,null,null,null);
commit;
...
insert into chat
values (0,null,null,'test',SYSDATE);

insert into business
values (0,0,'test','00','test',sysdate,sysdate,null,0,1,null);
...
insert into note
values (0,'test',SYSDATE,'N',0,0);

insert into advertisement
values(0,'코미와 ','192.168.0.77:8080/comi',0,'Y',sysdate,sysdate,null,1,0,null);

INSERT INTO REPORT VALUES (0,'TEST',SYSDATE,'TEST','N',NULL,NULL,NULL,NULL,NULL);
