...
<main class="main_wrapper">
		<div class="container">
			...
			<h2>공지사항 입력하기</h2>
			<!--공지사항 출력-->
			<div style="width: 500px; border: 2px solid #FFE436; border-radius: 8px; margin: 0 auto; text-align: center; background-color: #ffed76;">
				<form action="/comi/noticeins" method="post" enctype="multipart/form-data">
                    ...
                    <tr>
                        <th>작성자</th>
                        <td><input type="text" readonly value="<%= loginMember.getMeName() %>" size="50"></td>
                    </tr>
                    <tr>
                        <th>내 용</th>
