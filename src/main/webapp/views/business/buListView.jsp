<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.ArrayList, business.model.vo.Business, java.sql.Date" %>      
<%
...
<head>
<meta charset="UTF-8">
<title>bu_list_view</title>
<script type="text/javascript">
function showWriteForm(){
	location.href = "/comi/views/business/businessWriteForm.jsp";
}
</script>
</head>
<body>
