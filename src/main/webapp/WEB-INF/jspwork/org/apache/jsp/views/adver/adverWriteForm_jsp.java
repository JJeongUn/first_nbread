 ...
 * Generated at: 2023-09-07 08:47:47 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.views.adver;
...
public final class adverWriteForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/adver/../common/footer.jsp", Long.valueOf(1693893056761L));
    _jspx_dependants.put("/views/adver/../common/header.jsp", Long.valueOf(1693993811403L));
  }
 ...
 if(loginMember.getMePhotoAdd() == null) { 
      ...
      out.write("\r\n");
      out.write("			<!--게시판-->\r\n");
      out.write("           <div class=\"ad-container\" style=\"width: 550px; border: 2px solid #ffed76; margin: 0 auto; text-align: center;\">\r\n");
      out.write("				<form action=\"/comi/inadver\" method=\"post\"\r\n");
      out.write("					enctype=\"multipart/form-data\">\r\n");
      out.write("					<input class=\"form-group\" type=\"hidden\" name=\"writer\"\r\n");
      out.write("						value=\"");
      out.print(loginMember.getMeNum());
      out.write("\">\r\n");
      ...
      out.write("						<thead>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<th class=\"tg-3xi5\"><label for=\"title\">제목</label> <input\r\n");
      out.write("									class=\"form-group\" type=\"text\" name=\"title\" id=\"title\" placeholder=\"제목을 입력하세요\"></th>\r\n");
      out.write("							</tr>\r\n");
      out.write("						</thead>\r\n");
      out.write("						<tbody>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td class=\"tg-0pky\"><label for=\"content\">광고 URL</label> <input\r\n");
      out.write("									class=\"form-group\" type=\"text\" name=\"url\" id=\"url\" placeholder=\"URL을 입력하세요\"></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td class=\"tg-0pky\"><label for=\"file1\">첨부 파일 1</label> <input\r\n");
      out.write("									class=\"form-group\" type=\"file\" name=\"file1\" id=\"file1\" accept=\"image/*\"\r\n");
      out.write("									onchange=\"previewImage(this, 'preview1')\"> <img\r\n");
      out.write("									id=\"preview1\" src=\"#\" alt=\"미리보기 이미지\"\r\n");
      out.write("									style=\"display: none; max-width: 100px;\"></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td class=\"tg-0lax\"><label for=\"file2\">첨부 파일 2</label> <input\r\n");
      out.write("									class=\"form-group\" type=\"file\" name=\"file2\" id=\"file2\" accept=\"image/*\"\r\n");
      out.write("									onchange=\"previewImage(this, 'preview2')\"> <img\r\n");
      out.write("									id=\"preview2\" src=\"#\" alt=\"미리보기 이미지\"\r\n");
      out.write("									style=\"display: none; max-width: 100px;\"></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td class=\"tg-0lax\"><label for=\"file3\">첨부 파일 3</label> <input\r\n");
      out.write("									class=\"form-group\" type=\"file\" name=\"file3\" id=\"file3\" accept=\"image/*\"\r\n");
      out.write("									onchange=\"previewImage(this, 'preview3')\"> <img\r\n");
      out.write("									id=\"preview3\" src=\"#\" alt=\"미리보기 이미지\"\r\n");
      out.write("									style=\"display: none; max-width: 100px;\"></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td class=\"tg-0lax\"><label for=\"file4\">첨부 파일 4</label> <input\r\n");
      out.write("									class=\"form-group\" type=\"file\" name=\"file4\" id=\"file4\" accept=\"image/*\"\r\n");
      out.write("									onchange=\"previewImage(this, 'preview4')\"> <img\r\n");
      out.write("									id=\"preview4\" src=\"#\" alt=\"미리보기 이미지\"\r\n");
      out.write("									style=\"display: none; max-width: 100px;\"></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td class=\"tg-0lax\"><label for=\"file5\">첨부 파일 5</label> <input\r\n");
      out.write("									class=\"form-group\" type=\"file\" name=\"file5\" id=\"file5\" accept=\"image/*\"\r\n");
      out.write("									onchange=\"previewImage(this, 'preview5')\"> <img\r\n");
      out.write("									id=\"preview5\" src=\"#\" alt=\"미리보기 이미지\"\r\n");
      out.write("									style=\"display: none; max-width: 100px;\"></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td class=\"ad-date\">광고 시작 날짜<input class=\"form-group\" type=\"date\"\r\n");
      out.write("									name=\"startDate\" id=\"startDate\" required></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("							<tr>\r\n");
      out.write("								<td class=\"ad-date\">광고 종료 날짜<input class=\"form-group\" type=\"date\"\r\n");
      out.write("									name=\"endDate\" id=\"endDate\" required></td>\r\n");
      out.write("							</tr>\r\n");
      out.write("						</tbody>\r\n");
      out.write("					</table>\r\n");
      out.write("					\r\n");
      out.write("					<input class=\"btn\" type=\"submit\" value=\"글쓰기\">\r\n");
      out.write("				</form>\r\n");
      out.write("			</div>\r\n");
      out.write("           \r\n");
      out.write("           <!--게시판 E-->\r\n");
      out.write("            <script>\r\n");
      out.write("                // 파일 업로드 시 미리보기 이미지 업데이트 함수\r\n");
      out.write("                function previewImage(input, imgId) {\r\n");
      out.write("                    var preview = document.getElementById(imgId);\r\n");
      out.write("                    if (input.files && input.files[0]) {\r\n");
      out.write("                        var reader = new FileReader();\r\n");
      out.write("                        reader.onload = function (e) {\r\n");
      out.write("                            preview.src = e.target.result;\r\n");
      out.write("                            preview.style.display = 'block';\r\n");
      out.write("                            // 파일 입력(input type=\"file\") 숨기기\r\n");
      ...
      out.write("                        // 파일 입력(input type=\"file\") 다시 표시\r\n");
      ...
      out.write("					\r\n");
      out.write("					<button class=\"btn\" id=\"qa_list\" onclick=\"javascript:location.href='/comi/adsall?page=1';\" style=\"cursor:pointer \"> 목록\r\n");
      out.write("						\r\n");
      out.write("					</button>\r\n");
      out.write("					\r\n");
      out.write("				</div>\r\n");
