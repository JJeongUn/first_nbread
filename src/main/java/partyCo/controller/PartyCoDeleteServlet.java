 ...
 */
@WebServlet("/partycodel")
public class PartyCoDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PartyCoDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = coservice.deletePartyCo(comnum);
		
		if(result > 0) {
			System.out.println("삭제 완료");
			//댓글 수 업데이트 하기
			int upresult = coservice.updatePartyCoCount(parent, -1);
